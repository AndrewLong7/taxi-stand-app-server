...
def get_nearby_taxi_stands(user_lat, user_lng, user_hour, stand_type, stand_data, hk_geodata, distMethod="google"):
    """结合用户区域仅搜索本区域内的站点"""
    # 确定用户所在区域
...
def main():
    ...
    # 加载 JSON 数据
    json_file = get_resource_path("") # 需要站点.json文件中包含每个站点的分区信息
    ...
    while True:
        ...
        # 获取推荐的站点
        top_5_stand_ids = get_nearby_taxi_stands(user_lat, user_lng, user_hour, stand_type, stand_data, hk_geodata, methodChoice)
